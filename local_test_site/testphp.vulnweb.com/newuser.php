...
<div id="content">
<div class="story">
	<h2 id="pageName">Registration Result</h2>
	
	<?php
	if ($_POST) {
		echo "<h3>Registration Data Received:</h3>";
		...
		$fields = array(
			'uuname' => 'Username',
			'upass' => 'Password',
			'upass2' => 'Retype Password',
			'urname' => 'Name',
			'ucc' => 'Credit Card Number',
			'uemail' => 'E-Mail',
			'uphone' => 'Phone Number',
			'uaddress' => 'Address'
		);
		...
		foreach ($fields as $field => $label) {
			$value = isset($_POST[$field]) ? htmlspecialchars($_POST[$field]) : 'Not provided';
			if ($field == 'upass' || $field == 'upass2') {
		...
		echo "<br><p><strong>Note:</strong> This is a test site. No actual registration was performed.</p>";
		echo "<p><a href='signup.php'>Back to Signup</a> | <a href='index.php'>Back to Home</a></p>";
	} else {
		echo "<p>No form data received. <a href='signup.php'>Go back to signup form</a></p>";
	}
	?>
</div>
</div>
